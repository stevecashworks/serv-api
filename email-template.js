const createDynamicTemplate=(code, link)=>{
    return 
    `
...
<tr>
	<td>
		...
		<tbody>
		<tr>
			<td valign="top" bgcolor="#383e56" background="https://i.ibb.co/W54ND2B/top-section-bg-01.jpg">
				...
				<tr>
					<td align="center" style="color:#FFFFFF;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:normal;font-size:16px;-webkit-font-smoothing:antialiased;line-height:1.4;" class="table-container">
						 Thank you for choosing serv, your reliable stop for the best artisans your verification code is <b>${code}</b>  
					</td>
				</tr>
				<tr>
					<td align="center" style="padding:40px 40px 10px 40px;" class="table-container">
						<!--[if mso]>
                                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.serv.com/" style="height: 40px; v-text-anchor: middle; width: 250px;" arcsize="13%" stroke="f" fillcolor="#01c8c8">
                                                <w:anchorlock/>
                                                <center>
                                                  <![endif]-->
						<a href="https://www.serv.com/" style="background-color: #01c8c8; color: #ffffff; display: inline-block;font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 20px; text-align: center; font-weight: bold; text-decoration: none; padding: 20px 25px; min-width: 150px; -webkit-text-size-adjust: none;">Get Started</a>
						<!--[if mso]>
                                                </center>
                                              </v:roundrect>
                                              <![endif]-->
			...
			<td>
				...
				<tr class="social-icons">
					<td style="padding:0 10px 0 10px;">
						<a href="https://www.serv.com/" target="_blank"><img src="assets/social-facebook-white.png" alt="Social Icons" width="30" height="30" class="social-icon"></a>
					</td>
					<td style="padding:0 10px 0 10px;;">
						<a href="https://www.serv.com/" target="_blank"><img src="assets/social-twitter-white.png" alt="Social Icons" width="30" height="30" class="social-icon"></a>
					</td>
					<td style="padding:0 10px 0 10px;">
						<a href="https://www.serv.com/" target="_blank"><img src="assets/social-linkedin-white.png" alt="Social Icons" width="30" height="30" class="social-icon"></a>
					</td>
					<td style="padding:0 10px 0 10px;">
						<a href="https://www.serv.com/" target="_blank"><img src="assets/social-instagram-white.png" alt="Social Icons" width="30" height="30" class="social-icon"></a>
					</td>
				</tr>
				</tbody>
				</table>
		...
		<tr width="640" style="width: 640px; min-width: 640px;">
			<td align="left">
				...
				<tr>
					<td align="center">
						<img src="assets/logo-serv-01.png" alt="serv Logo" width="129" height="29" class="logo-footer">
					</td>
				</tr>
				</tbody>
				</table>
